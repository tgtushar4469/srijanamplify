...
function showSuccessModal(message) {
    ...
    document.getElementById('successBtnText').textContent = 'Continue';
    modal.style.display = 'block';
    document.body.style.overflow = 'hidden';
}

// Booking Success Modal with Premium Message
function showBookingSuccessModal() {
    const modal = document.getElementById('successModal');
    const title = document.getElementById('successTitle');
    const messageContainer = document.getElementById('successMessageContainer');
    const btnText = document.getElementById('successBtnText');

    title.textContent = '✅ Booking Submitted Successfully';

    messageContainer.innerHTML = `
        <p class="success-message booking-success">Thank you for choosing Amplify & CO.</p>
        <p class="success-message booking-detail">We have received your booking request successfully.</p>
        <p class="success-message booking-detail">Our team will review your requirements and contact you soon.</p>
        <p class="success-message booking-detail">Please keep your phone number and email active for further communication.</p>
    `;

    btnText.textContent = 'Continue Browsing';
